...
namespace LojaEstoque.Api.Controllers
{
    ...
    public class CarrinhoController : Controller
    {
        ...
        {
            CarrinhoResumoDto carrinhos = await _aplicCarrinho.Listar();
            return Ok(carrinhos);
        }
        #endregion
        ...
        #region Editar
        [HttpPut("Editar/{id}")]
        public async Task<IActionResult> Editar(Guid id, [FromBody] CarrinhoEditarDto carrinhoEditarDto)
        {
            Carrinho carrinho = await _aplicCarrinho.Editar(id, carrinhoEditarDto);
            return Ok(carrinho);
        }
        #endregion
