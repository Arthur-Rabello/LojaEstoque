...
namespace LojaEstoque.Aplicacao.Aplic
{
    public class AplicCarrinho : IAplicCarrinho
    {
        ...
        private readonly CarrinhoValidatorEditor _carrinhoValidatorEditor;
        private readonly IServCarrinho _servCarrinho;

        public AplicCarrinho(IServCarrinho servCarrinho)
        {
            _servCarrinho = servCarrinho;
            _carrinhoValidatorEditor = new CarrinhoValidatorEditor();
        ...
        {
            await _carrinhoValidatorEditor.ValidateAndThrowAsync(carrinhoEditarDto);
            Carrinho carrinho = await _servCarrinho.Editar(id, carrinhoEditarDto);
